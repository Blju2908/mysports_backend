...
class Set(SQLModel, table=True):
    ...
    def from_values_list(cls, values: List[Optional[Union[float, int, str]]]) -> Optional["Set"]:
        ...
        Values format: [weight, reps, duration, distance, rest_time]
        
        Args:
            values: List of values in the order [weight, reps, duration, distance, rest_time]
        ...
        # Ensure we have at least 5 values, pad with None if needed
        padded_values = values + [None] * (5 - len(values))
