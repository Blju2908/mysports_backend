...
Revision ID: f8a50a48ebf1
Revises: bf2ae59fa2c9
Create Date: 2025-05-14 09:01:11.910009
...
revision: str = 'f8a50a48ebf1'
down_revision: Union[str, None] = 'bf2ae59fa2c9'
...
def upgrade() -> None:
    ...
    op.add_column('workouts', sa.Column('focus', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
